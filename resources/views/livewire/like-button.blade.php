<button wire:loading.attr="disabled" wire:click='toggleLike' class="flex items-center">
    ...
    <svg wire:loading.delay aria-hidden="true" class="w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
