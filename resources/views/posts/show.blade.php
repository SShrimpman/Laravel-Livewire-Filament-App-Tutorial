<x-app-layout>
    <article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full" style="max-width:700px">
        ...
        <h1 class="text-4xl font-bold text-left text-gray-400">
            {{ $post->title}}
        </h1>
        ...
        <div class="article-content prose py-3 text-gray-500 text-lg text-justify">
            {!! $post->body !!}
        </div>
        ...
        <div class="mt-10 comments-box border-t border-gray-100 pt-10">
            <h2 class="text-2xl font-semibold text-gray-400 mb-5">Discussions</h2>
            <textarea
                class="w-full rounded-lg p-4 bg-gray-800 focus:outline-none text-sm text-white border-gray-400 placeholder:text-gray-100"
                cols="30" rows="7"></textarea>
            <button
                class="mt-3 inline-flex items-center justify-center h-10 px-4 font-medium tracking-wide text-gray-500 transition duration-200 bg-gray-900 rounded-lg hover:bg-gray-800 focus:shadow-outline focus:outline-none">
                Post Comment
            </button>
            ...
            <div class="user-comments px-3 py-2 mt-5">
                <div class="comment [&:not(:last-child)]:border-b border-gray-100 py-5">
                    <div class="user-meta flex mb-4 text-sm items-center">
                        ...
                        <span class="text-gray-500 mr-1">user name</span>
                        <span class="text-gray-600">. 15 days ago</span>
                    </div>
